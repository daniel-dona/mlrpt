...
RUN apt-get install git build-essential cmake wget libpython2-dev python-numpy swig g++ rtl-sdr librtlsdr-dev pkgconf libturbojpeg0-dev libconfig-dev ca-certificates -y
